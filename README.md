...
* Select all `.p12` files, `.pem` file and copy them to `src/main/resources` in the project folder.
...
You can change the default input passed to APIs, modifying values in the following file:
