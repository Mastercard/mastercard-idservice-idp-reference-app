...
* Open `${project.basedir}/src/main/resources/application.properties` and configure below parameters.
  ...
  **The properties below will be required for authentication of API calls.**
  ...
  >**mastercard.api.encryption.certificateFile=** contains the reference for the pem file certificate used by the client to encrypt payload, this file should be located at src/main/resources.
