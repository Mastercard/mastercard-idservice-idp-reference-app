...
@Service
public interface IDPAuthorizationClientService {

    IDPScopesAuthorizationData fillScopesFulfillment(String arid, IDPScopesAuthorization requestData, boolean encryptedPayload);
